...
public class AudioWaveAS {
    ...
    public AudioWaveAS(String fileName, String waveformFilename) throws UnsupportedAudioFileException, IOException {
    ...
    public static void main(String [] args) throws Exception {
        ...
        AudioWaveAS awc = new AudioWaveAS(args[0], args[1]);
